...
RouteUser.route("/user").get(AuthControle.Checker,UserControle.getUser).put(AuthControle.Checker,UserControle.UpdateUser).delete(AuthControle.Checker,UserControle.DeleteUser)
...
RouteUser.route('/').get(AuthControle.Checker,UserControle.getAllUser)
